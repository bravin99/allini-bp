        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndOfShelfLife = table.Column<DateOnly>(type: "date", nullable: true),
                    Image = table.Column<string>(type: "text", nullable: false),
                    Location = table.Column<int>(type: "integer", nullable: false),
                    Recieved = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastCount = table.Column<DateOnly>(type: "date", nullable: false),
                    SupplierId = table.Column<int>(type: "integer", nullable: true),
                    AdjustedCount = table.Column<double>(type: "double precision", nullable: true)
                },
                constraints: table =>
                {
